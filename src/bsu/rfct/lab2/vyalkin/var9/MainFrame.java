package bsu.rfct.lab2.vyalkin.var9;
...
public class MainFrame extends JFrame {
    ...
    {
//return ((Math.pow(Math.pow(Math.log(1 + z),2) + Math.cos(Math.PI*Math.pow(y,3)) , 0.25)) / (Math.pow(Math.cos(Math.exp(x))+Math.pow(1/x,0.5)+Math.exp(Math.pow(x,2)),Math.sin(x))));
